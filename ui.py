...
class UI:
    ...
    def setup_resolution_dropdown(self, button_x):
        ...
        dropdown_width = int(300 * self.sX)  # Increased base width for better text fitting
        dropdown_height = int(80 * self.sY)  # Increased base height to match other buttons
